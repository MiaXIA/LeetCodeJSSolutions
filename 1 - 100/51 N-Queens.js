...
//      ".Q.."]
//    ]
//Explanation: There exist 2 distinct solutions to the 4-queens puzzle as shown above
...
var backtrack = (res, n, board = [], r = 0) => {
    ...
    for (let c = 0; c < n; c++) {
        ...
        //Array.prototype.some() returns false for any condition put on an empty array
            board.push(c);
